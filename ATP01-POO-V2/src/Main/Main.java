...
public class Main {
    public static void main(String[] args) {
        ...
        String tipoDeArea = usuario.tipoDeAreaTerrenoUsu();

        financiamentos.add(new Casa(valorImovel, prazoFinanciamento, taxaJuros, 15000, 3000));
        financiamentos.add(new Casa(900000, 55, 3.0, 150000, 30000));
        financiamentos.add(new Apartamento(valorImovel, prazoFinanciamento, 4, 35,taxaJuros));
        financiamentos.add(new Apartamento(500000, 35, 5,2, 4));
        financiamentos.add(new Terreno(valorImovel, prazoFinanciamento, taxaJuros, tipoDeArea));
